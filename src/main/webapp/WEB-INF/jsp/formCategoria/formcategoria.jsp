	...
	<section class="page-section" id="formcategoria">
		<div class="container">
			<div class="text-center">
				...
				<h2 class="section-heading text-uppercase">Nova
					Categoria</h2>
				</c:if>
			...
			<form method="post"
				action="<c:url value="formcategoria/salvaCategoria"/>">
				<input type="hidden" name="categoria.id" value="${categoria.id }">
				<input type="hidden" name="categoria.ativo"
					value="${categoria.isAtivo() }">
				<!-- Criado o metodo e ação para redirecionar  -->
				<div class="row justify-content-md-center mb-5 text-center">
					<div class="col-md-12 align-self-center text-center">
						<div class="form-group input-login mx-auto">
							<input name="categoria.nome" value="${ categoria.nome }"
								minlength="2" maxlength="255" class="form-control" id="email"
