...
<body id="page-top">
	...
	<header class="masthead" id="login">
		<div class="container">
			<div class="masthead-subheading">Bem Vindo ao E-Commerce!</div>
			<div class="masthead-heading text-uppercase">Login</div>
			
			<!--  comando para exibir mensagem de erro -->
				...
				<div class="row justify-content-md-center mb-5 text-center">
					<div class="col-md-12 align-self-center text-center">
						<div class="form-group input-login mx-auto">
							<input name="email" value="${email}" class="form-control" id="email" type="email"
								placeholder="Email *" required="required"
								data-validation-required-message="Please enter your email address." />
							<p class="help-block text-danger"></p>
						</div>
						<div class="form-group mb-md-0 input-login mx-auto">
							<input name="senha" value="${senha}" minlength="6" class="form-control" id="phone" type="password"
	...
	<section class="page-section" id="beneficios">
		<div class="container">
			<div class="text-center">
				...
				<h3 class="section-subheading text-muted">Aqui no ECommerce
			...
			<div class="row text-center">
				<div class="col-md-4">
					...
					<p class="text-muted">Aqui você encontra e realiza sua compra
	...
	<footer class="footer py-4">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-4 text-lg-left">Copyright © ThiagoOliveira
					2021</div>
