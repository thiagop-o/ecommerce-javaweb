        ...
        <section class="page-section" id="beneficios">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Aqui no ECommerce você encontra os melhores preços!</h3>
                </div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © ThiagoOliveira 2021</div>
